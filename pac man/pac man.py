...
enemy_img = pygame.image.load("pac_enemy.png")
enemy_img = pygame.transform.scale(enemy_img, (TILE_SIZE, TILE_SIZE))

loot_img = pygame.image.load("loot.png") 
loot_img = pygame.transform.scale(loot_img, (TILE_SIZE, TILE_SIZE))
...
pygame.display.set_caption("8-Bit Dungeon Crawler")
